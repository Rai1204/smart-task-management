  ...
  return (
    ...
    >
      ...
      <svg
        ...
        style={{ position: isDarkMode ? 'absolute' : 'relative' }}
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      ...
      <span className="absolute inset-0 rounded-lg bg-primary-400 dark:bg-accent-400 opacity-0 group-hover:opacity-20 transition-opacity duration-300" />
    </button>
  );
};
